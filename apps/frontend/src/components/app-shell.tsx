...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const items=[[LayoutDashboard,t.overview,'/dashboard'],...(role==='ADMIN'?[]:workspaceItems),[UserRoundCog,'Организация','/teams'],[BarChart3,t.reports,'/reports'],[Gauge,t.analytics,'/analytics'],...(role==='ADMIN'?[[Users,t.admin,'/administration'] as const]:[])] as const;
