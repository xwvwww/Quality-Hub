...
export class ProjectsController {
  ...
  @Get()
  list(@Req() req: AuthRequest, @Query() query: ProjectQueryDto) {
  ...
  create(@Req() req: AuthRequest, @Body() dto: CreateProjectDto) {
    return this.projects.create(req.user.organizationId, req.user.sub, dto);
  }
  ...
  @Roles(
    ...
    MembershipRole.QA_LEAD,
    MembershipRole.QA_ENGINEER,
  )
  archive(@Req() req: AuthRequest, @Param("id", ParseUUIDPipe) id: string) {
